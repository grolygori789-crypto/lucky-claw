const CACHE_NAME = 'lucky-claw-shell-v18';
const CACHE_PREFIX = 'lucky-claw-shell-';
const BUILD_ID = '003.03';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './src/js/gameplay/stage-data.js?v=003.03',
  './src/js/gameplay/gameplay-model.js?v=003.03',
  './src/js/gameplay/sfx.js?v=003.03',
  './src/js/gameplay/claw-game.js?v=003.03',
  './src/locales/en.json',
  './src/locales/th.json',
  './src/locales/ja.json',
  './assets/machines/classic/cabinet-base.webp',
  './assets/machines/classic/gameplay-cabinet.png?v=003.03',
  './assets/machines/classic/gameplay-carriage.png?v=003.03',
  './assets/machines/classic/gameplay-claw-head.png?v=003.03',
  ...
  './assets/plushies/gameplay/shih-tzu-brown_front.png?v=003.03',
  './assets/plushies/gameplay/shih-tzu-brown_tilt.png?v=003.03',
  './assets/plushies/gameplay/shih-tzu-brown_rest.png?v=003.03',
  './assets/plushies/gameplay/shih-tzu-black_front.png?v=003.03',
  './assets/plushies/gameplay/shih-tzu-black_tilt.png?v=003.03',
  './assets/plushies/gameplay/shih-tzu-black_rest.png?v=003.03',
  './assets/plushies/gameplay/red-bear_front.png?v=003.03',
  './assets/plushies/gameplay/red-bear_tilt.png?v=003.03',
  './assets/plushies/gameplay/red-bear_rest.png?v=003.03',
  './assets/plushies/gameplay/yellow-chick_front.png?v=003.03',
  './assets/plushies/gameplay/yellow-chick_tilt.png?v=003.03',
  './assets/plushies/gameplay/yellow-chick_rest.png?v=003.03',
  './assets/plushies/gameplay/white-bunny_front.png?v=003.03',
  './assets/plushies/gameplay/white-bunny_tilt.png?v=003.03',
  './assets/plushies/gameplay/white-bunny_rest.png?v=003.03',
